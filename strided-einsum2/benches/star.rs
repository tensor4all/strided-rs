...
#[inline(never)]
fn run_star_f64(d: &mut StridedArray<f64>, a: &StridedArray<f64>, b: &StridedArray<f64>, c: &StridedArray<f64>, n: usize) {
    for j in 0..n {
        for k in 0..n {
            for l in 0..n {
                let mut s = 0.0f64;
...
#[inline(never)]
fn run_star_complex64(d: &mut StridedArray<Complex64>, a: &StridedArray<Complex64>, b: &StridedArray<Complex64>, c: &StridedArray<Complex64>, n: usize) {
    for j in 0..n {
        for k in 0..n {
            for l in 0..n {
...
fn main() {
    ...
    let shape_2 = [n, n];
    let shape_3 = [n, n, n];
    println!("strided-einsum2 bench: star (ein \"ij,ik,il->jkl\"), large ({}x{})", n, n);
    ...
    bench_n("star_f64_large", 1, 3, || { run_star_f64(&mut d, &a, &b, &c, n); black_box(d.data().as_ptr()); });
    ...
    bench_n("star_Complex64_large", 1, 3, || { run_star_complex64(&mut dc, &ac, &bc, &cc, n); black_box(dc.data().as_ptr()); });
}
